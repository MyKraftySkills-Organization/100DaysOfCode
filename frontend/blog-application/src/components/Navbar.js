...
export default function Navbar() {
    return (
        <header className="homepage-v1 hidden-sn animated">
            <nav className="navbar fixed-top navbar-expand-lg  navbar-light scrolling-navbar secondary-color">
                    ...
                    <div className="collapse navbar-collapse justify-content-center" id="navbarSupportedContent-4">
                        <ul className="navbar-nav">
                            ...
                            <li className="nav-item ml-4  mb-0">
                                    <Link to="/" className="nav-link waves-effect waves-light dark-grey-text font-weight-bold">HOMEPAGE</Link>
                            </li>

                            <li className="nav-item ml-4  mb-0">
                                 
                                    <Link to="post" className="nav-link waves-effect waves-light dark-grey-text font-weight-bold">POST PAGE</Link>
                                 
                            </li>
                            <li className="nav-item ml-4  mb-0">
                                 
                                    <Link to="about" className="nav-link waves-effect waves-light dark-grey-text font-weight-bold"> ABOUT</Link>
                                 
                            </li>
                            <li className="nav-item ml-4 mb-0">
                                  <Link className="nav-link waves-effect waves-light dark-grey-text font-weight-bold" to="#">CONTACT
                        ...
                        <li className="nav-item dropdown">
                                ...
                                <Link className="nav-link dropdown-toggle" id="navbarDropdownMenuLink-4" data-toggle="dropdown"
                                    ...
                                    <img src="https://mdbootstrap.com/img/Photos/Avatars/avatar-1.jpg" className="rounded-circle z-depth-0"
                                        alt="avatar image" height="35"/> Akshit </Link>
